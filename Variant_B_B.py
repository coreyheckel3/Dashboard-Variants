            ...
            html.Div([  # row
                html.Div([  # slider columns
                    ...
                    html.Button(id='loading-icon', n_clicks=0,
                                children=[html.Div(html.A('SUBMIT', id='download-link', download='data.csv', href="",
                                                          target="_blank"))],
                ...
                #                 style = {'display': 'inline-block', 'height': '36vh'}),
                #     ],className='four columns offset-by-one'),
                # ],className='row'),
                ...
                html.Div([  # row
                    ...
                    html.Div(children=[
                        ...
                        dcc.Graph(id='catapult_model', config={'displayModeBar': False}, style={'display': 'none'}),
                        # style={'height': '25vh','width': '1hw'}),
                        #           html.Div(id='container-button-basic'),
                        #           html.Button(id='loading-icon',
