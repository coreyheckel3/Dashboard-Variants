        ...
        dcc.Tab(label='Catapult Design Creator', children=[
            ...
            html.Div([  # row
                ...
                html.Div(children=[
                    ...
                    dcc.Graph(id='bar_outcomes', config={'displayModeBar': False}, style={'width': '500px', 'display': 'inline-block', 'vertical-align': 'top'})
                ...
                html.Div([  # column
                    dbc.Table(
                        ...
                        [html.Tbody([
                            ...
                            html.Tr(
                                [html.Td(["Cost of Catapult System (10", html.Sup(3), " USD)    "]), html.Td(id='TC')]),
