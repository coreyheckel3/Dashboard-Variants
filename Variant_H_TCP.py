...
app.layout = html.Div(children=[
    ...
    dcc.Tabs(id="tabs", children=[
        ...
        dcc.Tab(label='Catapult Design Creator', children=[
            ...
            html.Div([  # row
                ...
                html.Div(children=[
                    ...
                    html.Button(id='loading-icon', n_clicks=0,
                                children=[html.Div(html.A('SUBMIT', id='download-link', target="_blank"))],
                                style={'font-family': 'Times New Roman', 'font-size': '20px'}),
                    html.Div(["Input: ",
                              dcc.Input(id='my-input', value='initial value', type='text')], style={'display': 'none'}),
                ...
                html.Div([  # row
                    ...
                    ], className='five columns offset-by-one', style={'display': 'none'}),
            ...
            #             html.Button(id='loading-icon',n_clicks=0,
            #                 children=[html.Div(html.A('SUBMIT', id='download-link', download='data.csv', href="", target="_blank"))],
            #                 style={'font-family': 'Times New Roman' , 'font-size': '20px'}),
            #             html.Div(["Input: ",
